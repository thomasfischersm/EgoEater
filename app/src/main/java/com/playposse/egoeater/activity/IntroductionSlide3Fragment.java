 ...
 * to the user.
 */
public class IntroductionSlide3Fragment extends Fragment {

    @BindView(R.id.illustrationImageView) ImageView illustrationImageView;

    public IntroductionSlide3Fragment() {
    ...
    public View onCreateView(
        ...
        View rootView = inflater.inflate(
                R.layout.fragment_introduction_slide3,
                container,
                false);
